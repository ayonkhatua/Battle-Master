-- ========= FUNCTION: APPROVE/REJECT CREDIT REQUEST (v2 - FIX) =========
-- This function handles the approval or rejection of a credit transaction.

-- First, let's drop the old faulty function if it was partially created
DROP FUNCTION IF EXISTS approve_reject_credit(integer, text);
...
BEGIN
  ...
  ELSE
    -- CORRECTED: Removed the problematic backslashes.
